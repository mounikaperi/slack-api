...
router.post('/createSignInMagicalCode', loginController.createSignUpMagicalCode);
router.patch('/signInWithMagicalCode/:code', loginController.signUpWithMagicalCode);
